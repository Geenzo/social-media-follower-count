...
const { scrapeTwitterFunc, getAllTwitter, selectTwitter, selectTwitterByURL } = require('./routes/twitter')
const { scrapeInstagramFunc, getAllInstagram, selectInstagram, selectInstagramByURL } = require('./routes/instagram')
const { scrapeFacebookFunc, getAllFacebook, selectFacebook, selectFacebookByURL } = require('./routes/facebook')
