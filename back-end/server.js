...
const { scrapeInstagramFunc, getAllInstagram, selectInstagram, selectInstagramByURL, getInstagramPosts } = require('./routes/instagram')
...
app.post('/getInstagramPosts', getInstagramPosts)
